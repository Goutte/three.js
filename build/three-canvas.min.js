...
j.info.render.faces++;b(k.opacity);c(k.blending);Y=a.positionScreen.x;V=a.positionScreen.y;W=d.positionScreen.x;$=d.positionScreen.y;aa=e.positionScreen.x;U=e.positionScreen.y;u(Y,V,W,$,aa,U);(k instanceof THREE.MeshLambertMaterial||k instanceof THREE.MeshPhongMaterial)&&null===k.map?(S.copy(k.color),Q.copy(k.emissive),k.vertexColors===THREE.FaceColors&&S.multiply(i.color),!0===Fa?!1===k.wireframe&&k.shading==THREE.SmoothShading&&3==i.vertexNormalsLength?(M.copy(ta),P.copy(ta),F.copy(ta),n(i.v1.positionWorld,
i.vertexNormalsModel[0],M),n(i.v2.positionWorld,i.vertexNormalsModel[1],P),n(i.v3.positionWorld,i.vertexNormalsModel[2],F),M.multiply(S).add(Q),P.multiply(S).add(Q),F.multiply(S).add(Q),N.addColors(P,F).multiplyScalar(0.5),ea=E(M,P,F,N),C(Y,V,W,$,aa,U,0,0,1,0,0,1,ea)):(L.copy(ta),n(i.centroidModel,i.normalModel,L),L.multiply(S).add(Q),!0===k.wireframe?w(L,k.wireframeLinewidth,k.wireframeLinecap,k.wireframeLinejoin):z(L)):!0===k.wireframe?w(k.color,k.wireframeLinewidth,k.wireframeLinecap,k.wireframeLinejoin):
z(k.color)):k instanceof THREE.MeshBasicMaterial||k instanceof THREE.MeshLambertMaterial||k instanceof THREE.MeshPhongMaterial?null!==k.map?k.map.mapping instanceof THREE.UVMapping&&(ua=i.uvs[0],D(Y,V,W,$,aa,U,ua[f].x,ua[f].y,ua[g].x,ua[g].y,ua[h].x,ua[h].y,k.map)):null!==k.envMap?k.envMap.mapping instanceof THREE.SphericalReflectionMapping&&(ra.copy(i.vertexNormalsModelView[f]),za=0.5*ra.x+0.5,Ba=0.5*ra.y+0.5,ra.copy(i.vertexNormalsModelView[g]),Ja=0.5*ra.x+0.5,Ka=0.5*ra.y+0.5,ra.copy(i.vertexNormalsModelView[h]),
La=0.5*ra.x+0.5,Ma=0.5*ra.y+0.5,D(Y,V,W,$,aa,U,za,Ba,Ja,Ka,La,Ma,k.envMap)):(L.copy(k.color),k.vertexColors===THREE.FaceColors&&L.multiply(i.color),!0===k.wireframe?w(L,k.wireframeLinewidth,k.wireframeLinecap,k.wireframeLinejoin):z(L)):k instanceof THREE.MeshDepthMaterial?(R=l.near,ka=l.far,g=1-I(a.positionScreen.z*a.positionScreen.w,R,ka),M.setRGB(g,g,g),g=1-I(d.positionScreen.z*d.positionScreen.w,R,ka),P.setRGB(g,g,g),g=1-I(e.positionScreen.z*e.positionScreen.w,R,ka),F.setRGB(g,g,g),N.addColors(P,
F).multiplyScalar(0.5),ea=E(M,P,F,N),C(Y,V,W,$,aa,U,0,0,1,0,0,1,ea)):k instanceof THREE.MeshNormalMaterial&&(k.shading==THREE.FlatShading?(d=i.normalModelView,L.setRGB(d.x,d.y,d.z).multiplyScalar(0.5).addScalar(0.5),!0===k.wireframe?w(L,k.wireframeLinewidth,k.wireframeLinecap,k.wireframeLinejoin):z(L)):k.shading==THREE.SmoothShading&&(d=i.vertexNormalsModelView[f],M.setRGB(d.x,d.y,d.z).multiplyScalar(0.5).addScalar(0.5),d=i.vertexNormalsModelView[g],P.setRGB(d.x,d.y,d.z).multiplyScalar(0.5).addScalar(0.5),
d=i.vertexNormalsModelView[h],F.setRGB(d.x,d.y,d.z).multiplyScalar(0.5).addScalar(0.5),N.addColors(P,F).multiplyScalar(0.5),ea=E(M,P,F,N),C(Y,V,W,$,aa,U,0,0,1,0,0,1,ea)))}function u(a,b,c,d,e,f){r.beginPath();r.moveTo(a,b);r.lineTo(c,d);r.lineTo(e,f);r.closePath()}function x(a,b,c,d,e,f,g,h){r.beginPath();r.moveTo(a,b);r.lineTo(c,d);r.lineTo(e,f);r.lineTo(g,h);r.closePath()}function w(a,b,c,h){d(b);e(c);f(h);g(a.getStyle());r.stroke();fa.expandByScalar(2*b)}function z(a){i(a.getStyle());r.fill()}
...
p)*s,h=(1-h+q)*t,c=c-a,d=d-b,e=e-a,f=f-b,j=(j+p)*s-g,k=(1-k+q)*t-h,l=(l+p)*s-g,n=(1-n+q)*t-h,p=j*n-l*k;0===p?(void 0===wa[m.id]&&(b=document.createElement("canvas"),b.width=m.image.width,b.height=m.image.height,b=b.getContext("2d"),b.drawImage(m.image,0,0),wa[m.id]=b.getImageData(0,0,m.image.width,m.image.height).data),b=wa[m.id],g=4*(Math.floor(g)+Math.floor(h)*m.image.width),L.setRGB(b[g]/255,b[g+1]/255,b[g+2]/255),z(L)):(p=1/p,m=(n*c-k*e)*p,k=(n*d-k*f)*p,c=(j*e-l*c)*p,d=(j*f-l*d)*p,a=a-m*g-c*h,
g=b-k*g-d*h,r.save(),r.transform(m,k,c,d,a,g),r.fill(),r.restore())}}function C(a,b,c,d,e,f,g,h,i,j,k,l,m){var n,p;n=m.width-1;p=m.height-1;g*=n;h*=p;c-=a;d-=b;e-=a;f-=b;i=i*n-g;j=j*p-h;k=k*n-g;l=l*p-h;p=1/(i*l-k*j);n=(l*c-j*e)*p;j=(l*d-j*f)*p;c=(i*e-k*c)*p;d=(i*f-k*d)*p;a=a-n*g-c*h;b=b-j*g-d*h;r.save();r.transform(n,j,c,d,a,b);r.clip();r.drawImage(m,0,0);r.restore()}function E(a,b,c,d){la[0]=255*a.r|0;la[1]=255*a.g|0;la[2]=255*a.b|0;la[4]=255*b.r|0;la[5]=255*b.g|0;la[6]=255*b.b|0;la[8]=255*c.r|0;
la[9]=255*c.g|0;la[10]=255*c.b|0;la[12]=255*d.r|0;la[13]=255*d.g|0;la[14]=255*d.b|0;Da.putImageData(Ha,0,0);Ga.drawImage(Ca,0,0);return Ea}function I(a,b,c){a=(a-b)/(c-b);return a*a*(3-2*a)}function J(a,b){var c=b.x-a.x,d=b.y-a.y,e=c*c+d*d;0!==e&&(e=1/Math.sqrt(e),c*=e,d*=e,b.x+=c,b.y+=d,a.x-=c,a.y-=d)}if(!1===l instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{!0===this.autoClear&&this.clear();r.setTransform(1,0,0,-1,v,y);j.info.render.vertices=
0;j.info.render.faces=0;k=t.projectScene(a,l,this.sortObjects,this.sortElements);q=k.elements;p=k.lights;Fa=0<p.length;if(!0===Fa){ta.setRGB(0,0,0);Na.setRGB(0,0,0);Oa.setRGB(0,0,0);for(var O=0,T=p.length;O<T;O++){var A=p[O],G=A.color;A instanceof THREE.AmbientLight?ta.add(G):A instanceof THREE.DirectionalLight?Na.add(G):A instanceof THREE.PointLight&&Oa.add(G)}}O=0;for(T=q.length;O<T;O++){var K=q[O],A=K.material;if(!(void 0===A||!1===A.visible)){fa.makeEmpty();if(K instanceof THREE.RenderableParticle){m=
K;m.x*=v;m.y*=y;var G=m,ca=K;b(A.opacity);c(A.blending);var na=void 0,oa=void 0,pa=void 0,qa=void 0,ma=K=void 0,Ia=void 0;A instanceof THREE.ParticleBasicMaterial?null===A.map?(pa=ca.object.scale.x,qa=ca.object.scale.y,pa*=ca.scale.x*v,qa*=ca.scale.y*y,fa.min.set(G.x-pa,G.y-qa),fa.max.set(G.x+pa,G.y+qa),!1!==Aa.isIntersectionBox(fa)&&(i(A.color.getStyle()),r.save(),r.translate(G.x,G.y),r.rotate(-ca.rotation),r.scale(pa,qa),r.fillRect(-1,-1,2,2),r.restore())):(K=A.map.image,ma=K.width>>1,Ia=K.height>>
1,pa=ca.scale.x*v,qa=ca.scale.y*y,na=pa*ma,oa=qa*Ia,fa.min.set(G.x-na,G.y-oa),fa.max.set(G.x+na,G.y+oa),!1!==Aa.isIntersectionBox(fa)&&(r.save(),r.translate(G.x,G.y),r.rotate(-ca.rotation),r.scale(pa,-qa),r.translate(-ma,-Ia),r.drawImage(K,0,0),r.restore())):A instanceof THREE.ParticleCanvasMaterial&&(na=ca.scale.x*v,oa=ca.scale.y*y,fa.min.set(G.x-na,G.y-oa),fa.max.set(G.x+na,G.y+oa),!1!==Aa.isIntersectionBox(fa)&&(g(A.color.getStyle()),i(A.color.getStyle()),r.save(),r.translate(G.x,G.y),r.rotate(-ca.rotation),
r.scale(na,oa),A.program(r),r.restore()))}else if(K instanceof THREE.RenderableLine)m=K.v1,H=K.v2,m.positionScreen.x*=v,m.positionScreen.y*=y,H.positionScreen.x*=v,H.positionScreen.y*=y,fa.setFromPoints([m.positionScreen,H.positionScreen]),!0===Aa.isIntersectionBox(fa)&&(G=m,ca=H,b(A.opacity),c(A.blending),r.beginPath(),r.moveTo(G.positionScreen.x,G.positionScreen.y),r.lineTo(ca.positionScreen.x,ca.positionScreen.y),A instanceof THREE.LineBasicMaterial?(d(A.linewidth),e(A.linecap),f(A.linejoin),g(A.color.getStyle()),
h(null,null),r.stroke(),fa.expandByScalar(2*A.linewidth)):A instanceof THREE.LineDashedMaterial&&(d(A.linewidth),e(A.linecap),f(A.linejoin),g(A.color.getStyle()),h(A.dashSize,A.gapSize),r.stroke(),fa.expandByScalar(2*A.linewidth)));else if(K instanceof THREE.RenderableFace3){m=K.v1;H=K.v2;B=K.v3;if(-1>m.positionScreen.z||1<m.positionScreen.z)continue;if(-1>H.positionScreen.z||1<H.positionScreen.z)continue;if(-1>B.positionScreen.z||1<B.positionScreen.z)continue;m.positionScreen.x*=v;m.positionScreen.y*=
y;H.positionScreen.x*=v;H.positionScreen.y*=y;B.positionScreen.x*=v;B.positionScreen.y*=y;!0===A.overdraw&&(J(m.positionScreen,H.positionScreen),J(H.positionScreen,B.positionScreen),J(B.positionScreen,m.positionScreen));fa.setFromPoints([m.positionScreen,H.positionScreen,B.positionScreen]);s(m,H,B,0,1,2,K,A,a)}else if(K instanceof THREE.RenderableFace4){m=K.v1;H=K.v2;B=K.v3;Z=K.v4;if(-1>m.positionScreen.z||1<m.positionScreen.z)continue;if(-1>H.positionScreen.z||1<H.positionScreen.z)continue;if(-1>
B.positionScreen.z||1<B.positionScreen.z)continue;if(-1>Z.positionScreen.z||1<Z.positionScreen.z)continue;m.positionScreen.x*=v;m.positionScreen.y*=y;H.positionScreen.x*=v;H.positionScreen.y*=y;B.positionScreen.x*=v;B.positionScreen.y*=y;Z.positionScreen.x*=v;Z.positionScreen.y*=y;ha.positionScreen.copy(H.positionScreen);ja.positionScreen.copy(Z.positionScreen);!0===A.overdraw&&(J(m.positionScreen,H.positionScreen),J(H.positionScreen,Z.positionScreen),J(Z.positionScreen,m.positionScreen),J(B.positionScreen,
ha.positionScreen),J(B.positionScreen,ja.positionScreen));fa.setFromPoints([m.positionScreen,H.positionScreen,B.positionScreen,Z.positionScreen]);G=m;ca=H;na=B;oa=Z;pa=ha;qa=ja;ma=a;j.info.render.vertices+=4;j.info.render.faces++;b(A.opacity);c(A.blending);void 0!==A.map&&null!==A.map||void 0!==A.envMap&&null!==A.envMap?(s(G,ca,oa,0,1,3,K,A,ma),s(pa,na,qa,1,2,3,K,A,ma)):(Y=G.positionScreen.x,V=G.positionScreen.y,W=ca.positionScreen.x,$=ca.positionScreen.y,aa=na.positionScreen.x,U=na.positionScreen.y,
da=oa.positionScreen.x,sa=oa.positionScreen.y,xa=pa.positionScreen.x,ya=pa.positionScreen.y,va=qa.positionScreen.x,ga=qa.positionScreen.y,A instanceof THREE.MeshLambertMaterial||A instanceof THREE.MeshPhongMaterial?(S.copy(A.color),Q.copy(A.emissive),A.vertexColors===THREE.FaceColors&&S.multiply(K.color),!0===Fa?!1===A.wireframe&&A.shading==THREE.SmoothShading&&4==K.vertexNormalsLength?(M.copy(ta),P.copy(ta),F.copy(ta),N.copy(ta),n(K.v1.positionWorld,K.vertexNormalsModel[0],M),n(K.v2.positionWorld,
K.vertexNormalsModel[1],P),n(K.v4.positionWorld,K.vertexNormalsModel[3],F),n(K.v3.positionWorld,K.vertexNormalsModel[2],N),M.multiply(S).add(Q),P.multiply(S).add(Q),F.multiply(S).add(Q),N.multiply(S).add(Q),ea=E(M,P,F,N),u(Y,V,W,$,da,sa),C(Y,V,W,$,da,sa,0,0,1,0,0,1,ea),u(xa,ya,aa,U,va,ga),C(xa,ya,aa,U,va,ga,1,0,1,1,0,1,ea)):(L.copy(ta),n(K.centroidModel,K.normalModel,L),L.multiply(S).add(Q),x(Y,V,W,$,aa,U,da,sa),!0===A.wireframe?w(L,A.wireframeLinewidth,A.wireframeLinecap,A.wireframeLinejoin):z(L)):
(L.addColors(S,Q),x(Y,V,W,$,aa,U,da,sa),!0===A.wireframe?w(L,A.wireframeLinewidth,A.wireframeLinecap,A.wireframeLinejoin):z(L))):A instanceof THREE.MeshBasicMaterial?(L.copy(A.color),A.vertexColors===THREE.FaceColors&&L.multiply(K.color),x(Y,V,W,$,aa,U,da,sa),!0===A.wireframe?w(L,A.wireframeLinewidth,A.wireframeLinecap,A.wireframeLinejoin):z(L)):A instanceof THREE.MeshNormalMaterial?(G=void 0,A.shading==THREE.FlatShading?(G=K.normalModelView,L.setRGB(G.x,G.y,G.z).multiplyScalar(0.5).addScalar(0.5),
