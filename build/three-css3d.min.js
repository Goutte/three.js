...
var b=this.elements;return a.set(b[12],b[13],b[14])}}(),setPosition:function(a){var b=this.elements;b[12]=a.x;b[13]=a.y;b[14]=a.z;return this},getInverse:function(a,b){var c=this.elements,d=a.elements,f=d[0],g=d[4],e=d[8],h=d[12],i=d[1],j=d[5],k=d[9],m=d[13],l=d[2],p=d[6],q=d[10],r=d[14],n=d[3],s=d[7],u=d[11],t=d[15];c[0]=k*r*s-m*q*s+m*p*u-j*r*u-k*p*t+j*q*t;c[4]=h*q*s-e*r*s-h*p*u+g*r*u+e*p*t-g*q*t;c[8]=e*m*s-h*k*s+h*j*u-g*m*u-e*j*t+g*k*t;c[12]=h*k*p-e*m*p-h*j*q+g*m*q+e*j*r-g*k*r;c[1]=m*q*n-k*r*n-
m*l*u+i*r*u+k*l*t-i*q*t;c[5]=e*r*n-h*q*n+h*l*u-f*r*u-e*l*t+f*q*t;c[9]=h*k*n-e*m*n-h*i*u+f*m*u+e*i*t-f*k*t;c[13]=e*m*l-h*k*l+h*i*q-f*m*q-e*i*r+f*k*r;c[2]=j*r*n-m*p*n+m*l*s-i*r*s-j*l*t+i*p*t;c[6]=h*p*n-g*r*n-h*l*s+f*r*s+g*l*t-f*p*t;c[10]=g*m*n-h*j*n+h*i*s-f*m*s-g*i*t+f*j*t;c[14]=h*j*l-g*m*l-h*i*p+f*m*p+g*i*r-f*j*r;c[3]=k*p*n-j*q*n-k*l*s+i*q*s+j*l*u-i*p*u;c[7]=g*q*n-e*p*n+e*l*s-f*q*s-g*l*u+f*p*u;c[11]=e*j*n-g*k*n-e*i*s+f*k*s+g*i*u-f*j*u;c[15]=g*k*l-e*j*l+e*i*p-f*k*p-g*i*q+f*j*q;c=d[0]*c[0]+d[1]*c[4]+
d[2]*c[8]+d[3]*c[12];if(0==c){if(b)throw Error("Matrix4.getInverse(): can't invert matrix, determinant is 0");console.warn("Matrix4.getInverse(): can't invert matrix, determinant is 0");this.identity();return this}this.multiplyScalar(1/c);return this},compose:function(){var a=new THREE.Matrix4,b=new THREE.Matrix4;return function(c,d,f){var g=this.elements;a.identity();a.setRotationFromQuaternion(d);b.makeScale(f.x,f.y,f.z);this.multiplyMatrices(a,b);g[12]=c.x;g[13]=c.y;g[14]=c.z;return this}}(),decompose:function(){var a=
new THREE.Vector3,b=new THREE.Vector3,c=new THREE.Vector3,d=new THREE.Matrix4;return function(f,g,e){var h=this.elements;a.set(h[0],h[1],h[2]);b.set(h[4],h[5],h[6]);c.set(h[8],h[9],h[10]);f=f instanceof THREE.Vector3?f:new THREE.Vector3;g=g instanceof THREE.Quaternion?g:new THREE.Quaternion;e=e instanceof THREE.Vector3?e:new THREE.Vector3;e.x=a.length();e.y=b.length();e.z=c.length();f.x=h[12];f.y=h[13];f.z=h[14];d.copy(this);d.elements[0]/=e.x;d.elements[1]/=e.x;d.elements[2]/=e.x;d.elements[4]/=
e.y;d.elements[5]/=e.y;d.elements[6]/=e.y;d.elements[8]/=e.z;d.elements[9]/=e.z;d.elements[10]/=e.z;g.setFromRotationMatrix(d);return[f,g,e]}}(),extractPosition:function(a){var b=this.elements,a=a.elements;b[12]=a[12];b[13]=a[13];b[14]=a[14];return this},extractRotation:function(){var a=new THREE.Vector3;return function(b){var c=this.elements,b=b.elements,d=1/a.set(b[0],b[1],b[2]).length(),f=1/a.set(b[4],b[5],b[6]).length(),g=1/a.set(b[8],b[9],b[10]).length();c[0]=b[0]*d;c[1]=b[1]*d;c[2]=b[2]*d;c[4]=
...
a.matrixAutoUpdate=this.matrixAutoUpdate;a.matrixWorldNeedsUpdate=this.matrixWorldNeedsUpdate;a.quaternion.copy(this.quaternion);a.useQuaternion=this.useQuaternion;a.visible=this.visible;a.castShadow=this.castShadow;a.receiveShadow=this.receiveShadow;a.frustumCulled=this.frustumCulled;for(var b=0;b<this.children.length;b++)a.add(this.children[b].clone());return a}};THREE.Object3D.__m1=new THREE.Matrix4;THREE.Object3D.defaultEulerOrder="XYZ";THREE.Object3DIdCount=0;THREE.Projector=function(){function a(){if(g===h){var a=new THREE.RenderableObject;e.push(a);h++;g++;return a}return e[g++]}function b(){if(j===m){var a=new THREE.RenderableVertex;k.push(a);m++;j++;return a}return k[j++]}function c(a,b){return b.z-a.z}function d(a,b){var c=0,d=1,f=a.z+a.w,e=b.z+b.w,g=-a.z+a.w,h=-b.z+b.w;if(0<=f&&0<=e&&0<=g&&0<=h)return!0;if(0>f&&0>e||0>g&&0>h)return!1;0>f?c=Math.max(c,f/(f-e)):0>e&&(d=Math.min(d,f/(f-e)));0>g?c=Math.max(c,g/(g-h)):0>h&&(d=Math.min(d,g/(g-h)));if(d<
...
w.material=E.material,y.elements.push(w)));!0===ja&&y.elements.sort(c);return y}};THREE.Camera=function(){THREE.Object3D.call(this);this.matrixWorldInverse=new THREE.Matrix4;this.projectionMatrix=new THREE.Matrix4;this.projectionMatrixInverse=new THREE.Matrix4};THREE.Camera.prototype=Object.create(THREE.Object3D.prototype);THREE.Camera.prototype.lookAt=function(a){this.matrix.lookAt(this.position,a,this.up);!0===this.rotationAutoUpdate&&(!1===this.useQuaternion?this.rotation.setEulerFromRotationMatrix(this.matrix,this.eulerOrder):this.quaternion.copy(this.matrix.decompose()[1]))};THREE.PerspectiveCamera=function(a,b,c,d){THREE.Camera.call(this);this.fov=void 0!==a?a:50;this.aspect=void 0!==b?b:1;this.near=void 0!==c?c:0.1;this.far=void 0!==d?d:2E3;this.updateProjectionMatrix()};THREE.PerspectiveCamera.prototype=Object.create(THREE.Camera.prototype);THREE.PerspectiveCamera.prototype.setLens=function(a,b){void 0===b&&(b=24);this.fov=2*THREE.Math.radToDeg(Math.atan(b/(2*a)));this.updateProjectionMatrix()};
