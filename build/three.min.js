...
0;g[7]=0;g[11]=-1;g[15]=0;return this},makePerspective:function(a,b,c,d){var a=c*Math.tan(THREE.Math.degToRad(0.5*a)),e=-a;return this.makeFrustum(e*b,a*b,e,a,c,d)},makeOrthographic:function(a,b,c,d,e,f){var g=this.elements,h=b-a,i=c-d,k=f-e;g[0]=2/h;g[4]=0;g[8]=0;g[12]=-((b+a)/h);g[1]=0;g[5]=2/i;g[9]=0;g[13]=-((c+d)/i);g[2]=0;g[6]=0;g[10]=-2/k;g[14]=-((f+e)/k);g[3]=0;g[7]=0;g[11]=0;g[15]=1;return this},clone:function(){var a=this.elements;return new THREE.Matrix4(a[0],a[4],a[8],a[12],a[1],a[5],a[9],
a[13],a[2],a[6],a[10],a[14],a[3],a[7],a[11],a[15])}});THREE.Ray=function(a,b){this.origin=void 0!==a?a:new THREE.Vector3;this.direction=void 0!==b?b:new THREE.Vector3};
...
p(h.v1.positionWorld,h.vertexNormalsModel[0],ja),p(h.v2.positionWorld,h.vertexNormalsModel[1],ma),p(h.v3.positionWorld,h.vertexNormalsModel[2],X),ja.multiply(ra).add(fa),ma.multiply(ra).add(fa),X.multiply(ra).add(fa),ha.addColors(ma,X).multiplyScalar(0.5),Ta=H(ja,ma,X,ha),E(oa,J,da,ka,Y,L,0,0,1,0,0,1,Ta)):(ga.copy(ub),p(h.centroidModel,h.normalModel,ga),ga.multiply(ra).add(fa),!0===i.wireframe?B(ga,i.wireframeLinewidth,i.wireframeLinecap,i.wireframeLinejoin):A(ga)):!0===i.wireframe?B(i.color,i.wireframeLinewidth,
...
0.5,Ib=0.5*$a.y+0.5,$a.copy(h.vertexNormalsModelView[j]),ec=0.5*$a.x+0.5,mc=0.5*$a.y+0.5,F(oa,J,da,ka,Y,L,eb,ob,Hb,Ib,ec,mc,i.envMap)):(ga.copy(i.color),i.vertexColors===THREE.FaceColors&&ga.multiply(h.color),!0===i.wireframe?B(ga,i.wireframeLinewidth,i.wireframeLinecap,i.wireframeLinejoin):A(ga)):i instanceof THREE.MeshDepthMaterial?(ia=q.near,Qa=q.far,g=1-K(a.positionScreen.z*a.positionScreen.w,ia,Qa),ja.setRGB(g,g,g),g=1-K(d.positionScreen.z*d.positionScreen.w,ia,Qa),ma.setRGB(g,g,g),g=1-K(e.positionScreen.z*
...
Ea.expandByScalar(2*b)}function A(a){h(a.getStyle());w.fill()}function F(a,b,c,d,e,f,g,j,i,ea,k,m,l){if(!(l instanceof THREE.DataTexture||void 0===l.image||0==l.image.width)){if(!0===l.needsUpdate){var n=l.wrapS==THREE.RepeatWrapping,fb=l.wrapT==THREE.RepeatWrapping;Ya[l.id]=w.createPattern(l.image,!0===n&&!0===fb?"repeat":!0===n&&!1===fb?"repeat-x":!1===n&&!0===fb?"repeat-y":"no-repeat");l.needsUpdate=!1}void 0===Ya[l.id]?h("rgba(0,0,0,1)"):h(Ya[l.id]);var n=l.offset.x/l.repeat.x,fb=l.offset.y/l.repeat.y,
q=l.image.width*l.repeat.x,p=l.image.height*l.repeat.y,g=(g+n)*q,j=(1-j+fb)*p,c=c-a,d=d-b,e=e-a,f=f-b,i=(i+n)*q-g,ea=(1-ea+fb)*p-j,k=(k+n)*q-g,m=(1-m+fb)*p-j,n=i*m-k*ea;0===n?(void 0===Za[l.id]&&(b=document.createElement("canvas"),b.width=l.image.width,b.height=l.image.height,b=b.getContext("2d"),b.drawImage(l.image,0,0),Za[l.id]=b.getImageData(0,0,l.image.width,l.image.height).data),b=Za[l.id],g=4*(Math.floor(g)+Math.floor(j)*l.image.width),ga.setRGB(b[g]/255,b[g+1]/255,b[g+2]/255),A(ga)):(n=1/n,
l=(m*c-ea*e)*n,ea=(m*d-ea*f)*n,c=(i*e-k*c)*n,d=(i*f-k*d)*n,a=a-l*g-c*j,g=b-ea*g-d*j,w.save(),w.transform(l,ea,c,d,a,g),w.fill(),w.restore())}}function E(a,b,c,d,e,f,g,j,h,i,ea,k,l){var m,n;m=l.width-1;n=l.height-1;g*=m;j*=n;c-=a;d-=b;e-=a;f-=b;h=h*m-g;i=i*n-j;ea=ea*m-g;k=k*n-j;n=1/(h*k-ea*i);m=(k*c-i*e)*n;i=(k*d-i*f)*n;c=(h*e-ea*c)*n;d=(h*f-ea*d)*n;a=a-m*g-c*j;b=b-i*g-d*j;w.save();w.transform(m,i,c,d,a,b);w.clip();w.drawImage(l,0,0);w.restore()}function H(a,b,c,d){ab[0]=255*a.r|0;ab[1]=255*a.g|0;
...
else{!0===this.autoClear&&this.clear();w.setTransform(1,0,0,-1,t,x);k.info.render.vertices=0;k.info.render.faces=0;l=s.projectScene(a,q,this.sortObjects,this.sortElements);n=l.elements;m=l.lights;fc=0<m.length;if(!0===fc){ub.setRGB(0,0,0);gc.setRGB(0,0,0);Na.setRGB(0,0,0);for(var T=0,V=m.length;T<V;T++){var O=m[T],aa=O.color;O instanceof THREE.AmbientLight?ub.add(aa):O instanceof THREE.DirectionalLight?gc.add(aa):O instanceof THREE.PointLight&&Na.add(aa)}}T=0;for(V=n.length;T<V;T++){var ea=n[T],O=
...
THREE.SmoothShading&&4==ea.vertexNormalsLength?(ja.copy(ub),ma.copy(ub),X.copy(ub),ha.copy(ub),p(ea.v1.positionWorld,ea.vertexNormalsModel[0],ja),p(ea.v2.positionWorld,ea.vertexNormalsModel[1],ma),p(ea.v4.positionWorld,ea.vertexNormalsModel[3],X),p(ea.v3.positionWorld,ea.vertexNormalsModel[2],ha),ja.multiply(ra).add(fa),ma.multiply(ra).add(fa),X.multiply(ra).add(fa),ha.multiply(ra).add(fa),Ta=H(ja,ma,X,ha),v(oa,J,da,ka,va,Xa),E(oa,J,da,ka,va,Xa,0,0,1,0,0,1,Ta),v(lb,Gb,Y,L,ta,Ma),E(lb,Gb,Y,L,ta,Ma,
1,0,1,1,0,1,Ta)):(ga.copy(ub),p(ea.centroidModel,ea.normalModel,ga),ga.multiply(ra).add(fa),z(oa,J,da,ka,Y,L,va,Xa),!0===O.wireframe?B(ga,O.wireframeLinewidth,O.wireframeLinecap,O.wireframeLinejoin):A(ga)):(ga.addColors(ra,fa),z(oa,J,da,ka,Y,L,va,Xa),!0===O.wireframe?B(ga,O.wireframeLinewidth,O.wireframeLinecap,O.wireframeLinejoin):A(ga))):O instanceof THREE.MeshBasicMaterial?(ga.copy(O.color),O.vertexColors===THREE.FaceColors&&ga.multiply(ea.color),z(oa,J,da,ka,Y,L,va,Xa),!0===O.wireframe?B(ga,O.wireframeLinewidth,
...
(i.fogNear.value=c.near,i.fogFar.value=c.far):c instanceof THREE.FogExp2&&(i.fogDensity.value=c.density));if(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||d.lights){if($a){for(var l,m=k=0,n=0,q,p,s,r=wb,t=r.directional.colors,w=r.directional.positions,v=r.point.colors,x=r.point.positions,C=r.point.distances,A=r.spot.colors,E=r.spot.positions,I=r.spot.distances,H=r.spot.directions,J=r.spot.anglesCos,O=r.spot.exponents,T=r.hemi.skyColors,X=r.hemi.groundColors,va=r.hemi.positions,
W=0,V=0,ja=0,da=0,ha=0,ka=0,fa=0,Xa=0,N=l=0,c=s=N=0,f=b.length;c<f;c++)l=b[c],l.onlyShadow||(q=l.color,p=l.intensity,s=l.distance,l instanceof THREE.AmbientLight?l.visible&&(L.gammaInput?(k+=q.r*q.r,m+=q.g*q.g,n+=q.b*q.b):(k+=q.r,m+=q.g,n+=q.b)):l instanceof THREE.DirectionalLight?(ha+=1,l.visible&&(Na.copy(l.matrixWorld.getPosition()),Na.sub(l.target.matrixWorld.getPosition()),Na.normalize(),0===Na.x&&0===Na.y&&0===Na.z||(l=3*W,w[l]=Na.x,w[l+1]=Na.y,w[l+2]=Na.z,L.gammaInput?z(t,l,q,p*p):K(t,l,q,
p),W+=1))):l instanceof THREE.PointLight?(ka+=1,l.visible&&(N=3*V,L.gammaInput?z(v,N,q,p*p):K(v,N,q,p),p=l.matrixWorld.getPosition(),x[N]=p.x,x[N+1]=p.y,x[N+2]=p.z,C[V]=s,V+=1)):l instanceof THREE.SpotLight?(fa+=1,l.visible&&(N=3*ja,L.gammaInput?z(A,N,q,p*p):K(A,N,q,p),p=l.matrixWorld.getPosition(),E[N]=p.x,E[N+1]=p.y,E[N+2]=p.z,I[ja]=s,Na.copy(p),Na.sub(l.target.matrixWorld.getPosition()),Na.normalize(),H[N]=Na.x,H[N+1]=Na.y,H[N+2]=Na.z,J[ja]=Math.cos(l.angle),O[ja]=l.exponent,ja+=1)):l instanceof
THREE.HemisphereLight&&(Xa+=1,l.visible&&(Na.copy(l.matrixWorld.getPosition()),Na.normalize(),0===Na.x&&0===Na.y&&0===Na.z||(s=3*da,va[s]=Na.x,va[s+1]=Na.y,va[s+2]=Na.z,q=l.color,l=l.groundColor,L.gammaInput?(p*=p,z(T,s,q,p),z(X,s,l,p)):(K(T,s,q,p),K(X,s,l,p)),da+=1))));c=3*W;for(f=Math.max(t.length,3*ha);c<f;c++)t[c]=0;c=3*V;for(f=Math.max(v.length,3*ka);c<f;c++)v[c]=0;c=3*ja;for(f=Math.max(A.length,3*fa);c<f;c++)A[c]=0;c=3*da;for(f=Math.max(T.length,3*Xa);c<f;c++)T[c]=0;c=3*da;for(f=Math.max(X.length,
3*Xa);c<f;c++)X[c]=0;r.directional.length=W;r.point.length=V;r.spot.length=ja;r.hemi.length=da;r.ambient[0]=k;r.ambient[1]=m;r.ambient[2]=n;$a=!1}c=wb;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=c.spot.positions;
...
THREE.SpotLight||k instanceof THREE.DirectionalLight&&!k.shadowCascade))i.shadowMap.value[Y]=k.shadowMap,i.shadowMapSize.value[Y]=k.shadowMapSize,i.shadowMatrix.value[Y]=k.shadowMatrix,i.shadowDarkness.value[Y]=k.shadowDarkness,i.shadowBias.value[Y]=k.shadowBias,Y++}b=d.uniformsList;i=0;for(Y=b.length;i<Y;i++)if(f=g.uniforms[b[i][1]])if(c=b[i][0],m=c.type,k=c.value,"i"===m)j.uniform1i(f,k);else if("f"===m)j.uniform1f(f,k);else if("v2"===m)j.uniform2f(f,k.x,k.y);else if("v3"===m)j.uniform3f(f,k.x,
...
new Float32Array(16*k.length));m=0;for(n=k.length;m<n;m++)k[m].flattenToArrayOffset(c._array,16*m);j.uniformMatrix4fv(f,!1,c._array)}else if("t"===m){if(r=k,k=F(),j.uniform1i(f,k),r)if(r.image instanceof Array&&6===r.image.length){if(c=r,f=k,6===c.image.length)if(c.needsUpdate){c.image.__webglTextureCube||(c.image.__webglTextureCube=j.createTexture(),L.info.memory.textures++);j.activeTexture(j.TEXTURE0+f);j.bindTexture(j.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);j.pixelStorei(j.UNPACK_FLIP_Y_WEBGL,
c.flipY);f=c instanceof THREE.CompressedTexture;k=[];for(m=0;6>m;m++)L.autoScaleCubemaps&&!f?(n=k,r=m,t=c.image[m],v=id,t.width<=v&&t.height<=v||(x=Math.max(t.width,t.height),w=Math.floor(t.width*v/x),v=Math.floor(t.height*v/x),x=document.createElement("canvas"),x.width=w,x.height=v,x.getContext("2d").drawImage(t,0,0,t.width,t.height,0,0,w,v),t=x),n[r]=t):k[m]=c.image[m];m=k[0];n=0===(m.width&m.width-1)&&0===(m.height&m.height-1);r=G(c.format);t=G(c.type);B(j.TEXTURE_CUBE_MAP,c,n);for(m=0;6>m;m++)if(f){v=
k[m].mipmaps;x=0;for(C=v.length;x<C;x++)w=v[x],j.compressedTexImage2D(j.TEXTURE_CUBE_MAP_POSITIVE_X+m,x,r,w.width,w.height,0,w.data)}else j.texImage2D(j.TEXTURE_CUBE_MAP_POSITIVE_X+m,0,r,r,t,k[m]);c.generateMipmaps&&n&&j.generateMipmap(j.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else j.activeTexture(j.TEXTURE0+f),j.bindTexture(j.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else r instanceof THREE.WebGLRenderTargetCube?(c=r,j.activeTexture(j.TEXTURE0+k),j.bindTexture(j.TEXTURE_CUBE_MAP,
c.__webglTexture)):L.setTexture(r,k)}else if("tv"===m){void 0===c._array&&(c._array=[]);m=0;for(n=c.value.length;m<n;m++)c._array[m]=F();j.uniform1iv(f,c._array);m=0;for(n=c.value.length;m<n;m++)r=c.value[m],k=c._array[m],r&&L.setTexture(r,k)}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&null!==h.cameraPosition)b=a.matrixWorld.getPosition(),j.uniform3f(h.cameraPosition,b.x,b.y,b.z);(d instanceof THREE.MeshPhongMaterial||d instanceof THREE.MeshLambertMaterial||
...
function(a){a.__webglObjects||(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;){var b=a.__objectsAdded[0],k=a,n=void 0,l=void 0,q=void 0,r=void 0;if(!b.__webglInit)if(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=new THREE.Matrix3,void 0!==b.geometry&&void 0===b.geometry.__webglInit&&(b.geometry.__webglInit=!0,b.geometry.addEventListener("dispose",xd)),b instanceof THREE.Mesh)if(l=b.geometry,q=b.material,
l instanceof THREE.Geometry){if(void 0===l.geometryGroups){var s=l,z=void 0,C=void 0,B=void 0,A=void 0,F=void 0,E=void 0,G={},H=s.morphTargets.length,I=s.morphNormals.length,K=q instanceof THREE.MeshFaceMaterial;s.geometryGroups={};z=0;for(C=s.faces.length;z<C;z++)B=s.faces[z],A=K?B.materialIndex:0,void 0===G[A]&&(G[A]={hash:A,counter:0}),E=G[A].hash+"_"+G[A].counter,void 0===s.geometryGroups[E]&&(s.geometryGroups[E]={faces3:[],faces4:[],materialIndex:A,vertices:0,numMorphTargets:H,numMorphNormals:I}),
F=B instanceof THREE.Face3?3:4,65535<s.geometryGroups[E].vertices+F&&(G[A].counter+=1,E=G[A].hash+"_"+G[A].counter,void 0===s.geometryGroups[E]&&(s.geometryGroups[E]={faces3:[],faces4:[],materialIndex:A,vertices:0,numMorphTargets:H,numMorphNormals:I})),B instanceof THREE.Face3?s.geometryGroups[E].faces3.push(z):s.geometryGroups[E].faces4.push(z),s.geometryGroups[E].vertices+=F;s.geometryGroupsList=[];var M=void 0;for(M in s.geometryGroups)s.geometryGroups[M].id=ja++,s.geometryGroupsList.push(s.geometryGroups[M])}for(n in l.geometryGroups)if(r=
...
(l=b.geometry,!l.__webglVertexBuffer))if(l instanceof THREE.Geometry){var ma=l;ma.__webglVertexBuffer=j.createBuffer();ma.__webglColorBuffer=j.createBuffer();L.info.memory.geometries++;var ha=l,ka=b,Xa=ha.vertices.length;ha.__vertexArray=new Float32Array(3*Xa);ha.__colorArray=new Float32Array(3*Xa);ha.__sortArray=[];ha.__webglParticleCount=Xa;c(ha,ka);l.verticesNeedUpdate=!0;l.colorsNeedUpdate=!0}else l instanceof THREE.BufferGeometry&&h(l);if(!b.__webglActive){if(b instanceof THREE.Mesh)if(l=b.geometry,
l instanceof THREE.BufferGeometry)p(k.__webglObjects,l,b);else{if(l instanceof THREE.Geometry)for(n in l.geometryGroups)r=l.geometryGroups[n],p(k.__webglObjects,r,b)}else b instanceof THREE.Ribbon||b instanceof THREE.Line||b instanceof THREE.ParticleSystem?(l=b.geometry,p(k.__webglObjects,l,b)):b instanceof THREE.ImmediateRenderObject||b.immediateRenderCallback?k.__webglObjectsImmediate.push({object:b,opaque:null,transparent:null}):b instanceof THREE.Sprite?k.__webglSprites.push(b):b instanceof THREE.LensFlare&&
...
x);for(x=0;x<c.maxMorphNormals;x++)t.push("morphNormal"+x);for(k in b)t.push(k);k=t;x=0;for(b=k.length;x<b;x++)t=k[x],w.attributes[t]=j.getAttribLocation(w,t);w.id=Xa++;va.push({program:w,code:n,usedTimes:1});L.info.memory.programs=va.length;k=w}a.program=k;x=a.program.attributes;if(a.morphTargets){a.numSupportedMorphTargets=0;b="morphTarget";for(k=0;k<this.maxMorphTargets;k++)w=b+k,0<=x[w]&&a.numSupportedMorphTargets++}if(a.morphNormals){a.numSupportedMorphNormals=0;b="morphNormal";for(k=0;k<this.maxMorphNormals;k++)w=
...
j.createTexture();L.info.memory.textures++;var c=0===(a.width&a.width-1)&&0===(a.height&a.height-1),d=G(a.format),e=G(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];j.bindTexture(j.TEXTURE_CUBE_MAP,a.__webglTexture);B(j.TEXTURE_CUBE_MAP,a,c);for(var f=0;6>f;f++){a.__webglFramebuffer[f]=j.createFramebuffer();a.__webglRenderbuffer[f]=j.createRenderbuffer();j.texImage2D(j.TEXTURE_CUBE_MAP_POSITIVE_X+f,0,d,a.width,a.height,0,d,e,null);var g=a,h=j.TEXTURE_CUBE_MAP_POSITIVE_X+f;j.bindFramebuffer(j.FRAMEBUFFER,
...
g=0;g<h;g++){var i=ua*g,k=ua*(g+1),m=d+e+i,i=d+f+i,n=d+f+k,k=d+e+k,p=c,q=g,r=h,t=e,v=f,m=m+V,i=i+V,n=n+V,k=k+V;E.faces.push(new THREE.Face4(m,i,n,k,null,null,x));m=w.generateSideWallUV(E,a,p,b,m,i,n,k,q,r,t,v);E.faceVertexUvs[0].push(m)}}}function f(a,b,c){E.vertices.push(new THREE.Vector3(a,b,c))}function g(c,d,e,f){c+=V;d+=V;e+=V;E.faces.push(new THREE.Face3(c,d,e,null,null,t));c=f?w.generateBottomUV(E,a,b,c,d,e):w.generateTopUV(E,a,b,c,d,e);E.faceVertexUvs[0].push(c)}var h=void 0!==b.amount?b.amount:
